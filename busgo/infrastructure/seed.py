...
def seed():
    ...
    try:
        ...
        users = [
            {"name": "Admin User", "phone": "01700000001", "password": "Test@123", "role": "ADMIN"},
            {"name": "Test User", "phone": "01700000000", "password": "Test@123", "role": "USER"},
            {"name": "Operator User", "phone": "01700000002", "password": "Test@123", "role": "OPERATOR"},
        ]
