...
const METHODS: { id: Method; label: string; icon: keyof typeof Ionicons.glyphMap; funds: 'MOBILE' | 'BANK'; brand: string }[] = [
  { id: 'BKASH', label: 'bKash', icon: 'phone-portrait-outline', funds: 'MOBILE', brand: '#e2136e' },
  { id: 'NAGAD', label: 'Nagad', icon: 'phone-portrait-outline', funds: 'MOBILE', brand: '#f6921e' },
  { id: 'CARD', label: 'Card', icon: 'card-outline', funds: 'BANK', brand: '#1d4ed8' },
];
