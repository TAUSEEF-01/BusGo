...
def main():
    ...
    try:
        ...
        print("Running: sudo docker logs --tail 20 infrastructure-payment-service-1")
        stdin, stdout, stderr = ssh.exec_command("sudo docker logs --tail 20 infrastructure-payment-service-1")
